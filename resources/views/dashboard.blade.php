    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 col-span-1">
                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">AI Cost / Inspection</p>
                    <p class="mt-2 text-3xl font-bold text-indigo-600">$0.01</p>
                    <p class="mt-1 text-xs text-gray-400">Claude + YOLOv8</p>
                </div>
