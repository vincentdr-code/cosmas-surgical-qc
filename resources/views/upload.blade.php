    ...
    <div style="max-width:800px; margin:0 auto;">
        ...
        <div class="tac-card">
            ...
            <form action="{{ route('inspections.store') }}" method="POST" enctype="multipart/form-data" id="inspectForm">
                ...
                {{-- Inspector framing --}}
                <div style="margin-top:20px; padding:12px 16px; background:rgba(201,150,62,0.05); border:1px solid rgba(201,150,62,0.15); border-left:3px solid rgba(201,150,62,0.5); font-size:10px; color:rgba(138,155,174,0.75); line-height:1.6; letter-spacing:0.04em;">
                    DAMIAN surfaces defect evidence and regulatory context. <strong style="color:rgba(201,150,62,0.85);">You make the final call.</strong> The AI recommendation, confidence score, and full reasoning chain will be shown on the results page for your review.
                </div>
