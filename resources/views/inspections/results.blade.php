                            ...
                            @elseif($tool === 'run_yolo_scan')
                                @if(!empty($result['detections']))
                                    <div style="font-size:11px; color:var(--text); margin-bottom:6px;">
                                        {{ $result['count'] }} detection(s) · {{ $result['model_used'] }} · {{ $result['inference_ms'] }}ms
                                    </div>
            ...
            <div style="background:var(--card); border:1px solid var(--gold-dim); padding:16px;">
                ...
                <table style="width:100%; font-size:11px;">
                    ...
                    <tr>
                        ...
                        <td style="color:var(--text); text-align:right; border:none;">{{ $inspection->yolo_model ?? 'unavailable' }}</td>
                    </tr>
                    <tr>
                        <td style="color:var(--muted); padding:4px 0; border:none;">Inference Time</td>
                        <td style="color:var(--text); text-align:right; border:none;">
                            {{ $inspection->inference_ms ? $inspection->inference_ms . 'ms' : '—' }}
                        </td>
                    </tr>
                    @if($crs !== null)
                    <tr>
